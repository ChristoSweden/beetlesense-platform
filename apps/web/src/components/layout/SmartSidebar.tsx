  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'regional-beetle-network', to: '/owner/regional-beetle-network', label: t('nav.regionalBeetleNetwork', 'Regional Beetle Network'), icon: RadioTower },
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'consultants', to: '/owner/consultants', label: t('nav.consultants', 'Find a Forester'), icon: GraduationCap },
