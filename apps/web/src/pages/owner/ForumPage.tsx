  ...
  if (filtered.length === 0) {
    return (
      <div className="text-center py-16">
        <MessagesSquare size={32} className="mx-auto text-stone-300 mb-3" />
        <p className="text-base font-semibold text-stone-500">Be the first to post here.</p>
        <p className="text-sm text-stone-400 mt-1 max-w-xs mx-auto">This is your community space. Share a sighting, ask a question, or start a discussion with nearby forest owners.</p>
      </div>
    );
  }
