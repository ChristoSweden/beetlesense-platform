...
import { TimberSaleFlow } from '@/components/transactions/TimberSaleFlow';

export default function TimberSalePage() {
  return (
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div className="flex items-center gap-2">
            <div className="w-9 h-9 rounded-lg flex items-center justify-center bg-[var(--green)]/10">
              <Banknote size={18} className="text-[var(--green)]" />
            </div>
            <div>
              <h1 className="text-lg font-bold text-[var(--text)]">Timber Sale</h1>
              <p className="text-[11px] text-[var(--text3)]">Create and send a timber sale request</p>
            </div>
          </div>
        </div>
