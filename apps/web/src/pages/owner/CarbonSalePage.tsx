...
import { CarbonCreditFlow } from '@/components/transactions/CarbonCreditFlow';

export default function CarbonSalePage() {
  return (
      ...
      <div className="max-w-lg mx-auto px-4 py-6">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <h1 className="text-lg font-bold text-[var(--text)]">Sell Carbon Credits</h1>
              <p className="text-[11px] text-[var(--text3)]">Monetize your forest's carbon sequestration</p>
            </div>
          </div>
        </div>
