...
const DEMO_SEQUENCE = [
  { step: 1, title: 'The Problem', duration: '2 min', content: 'Sweden lost 32M m³ of spruce timber to bark beetles 2018-2022. 44,000+ forest owners affected. Current detection relies on visual inspection — by the time you see damage, it is 6 weeks too late.', visual: 'Satellite before/after', cta: null },
  { step: 2, title: 'Spectral Detection', duration: '3 min', content: 'BeetleSense uses Sentinel-2 multispectral analysis (NDVI, EVI, GNDVI, Red Edge) to detect stress signatures 4-6 weeks before visible damage. Our Bayesian classifier achieves 89% accuracy.', visual: 'Live spectral demo', cta: '/owner/spectral-fingerprint' },
  { step: 3, title: 'Prediction Engine', duration: '2 min', content: 'Degree-day accumulation model predicts swarming windows. 334°d above 5°C = first flight. IoT sensors feed real-time microclimate data for per-stand predictions.', visual: 'Predictor + IoT dashboard', cta: '/owner/green-attack-predictor' },
  { step: 4, title: 'Verification Pipeline', duration: '2 min', content: 'Satellite anomaly → automated drone mission → multispectral AI verification → ground truth confirmation. Eliminates false positives, validates true detections.', visual: 'Drone workflow', cta: '/owner/drone-verification' },
    ...
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <div className="bg-gradient-to-br from-green-800 via-emerald-900 to-gray-900 px-6 py-16">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-block bg-white/10 backdrop-blur px-4 py-1 rounded-full text-sm mb-4">Forest Innovation Summit • Silicon Valley • April 20, 2026</div>
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        <h2 className="text-2xl font-bold mb-8">Demo Script — {totalDuration} Minutes</h2>
              ...
              <div className="flex items-start justify-between mb-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <span className="text-sm text-gray-400">{step.duration} • {step.visual}</span>
                  </div>
                </div>
                {step.cta && <Link to={step.cta} className="bg-green-600 hover:bg-green-700 px-4 py-2 rounded-lg text-sm font-medium">Open Demo →</Link>}
              </div>
      ...
      <div className="bg-gray-800 py-12 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              'Sweden lost 32M m³ of timber to bark beetles 2018-2022 (Skogsstyrelsen)',
              '89% detection accuracy with Sentinel-2 spectral analysis (peer-reviewed)',
              'Detects stress 4-6 weeks before visible damage — the critical intervention window',
              '334 degree-days above 5°C = Ips typographus swarming threshold',
              'EU ETS carbon pricing at €72/ton makes standing timber increasingly valuable',
              ...
              'FORWARDS/ROB4GREEN EU grant application submitted for €60K funding',
            ].map((point, i) => (
      ...
      <div className="max-w-4xl mx-auto px-6 py-12 text-center">
        <Link to="/owner/dashboard" className="inline-block bg-green-600 hover:bg-green-700 text-white px-8 py-4 rounded-xl text-lg font-bold transition-colors">Enter Command Center →</Link>
      </div>
    </div>
  );
}